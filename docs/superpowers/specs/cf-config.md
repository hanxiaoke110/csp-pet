...
| 密钥 | 值 | 用途 |
|------|------|------|
| SERVER_SECRET | `29bedf0f9ffd082d728ecdcf65db99dcf9671d94815b1f2953790a19dc508bfe` | AES 加密隐私数据 |
...
```bash
cd csp-desktop-pet
CLOUDFLARE_API_TOKEN="cfut_9Z2eXQ70rHHOmEiRV1lPl8E8q6C92Yn5mg3aEuPQ961e2771" npx wrangler deploy
```
...
```bash
cd csp-desktop-pet
CLOUDFLARE_API_TOKEN="cfut_9Z2eXQ70rHHOmEiRV1lPl8E8q6C92Yn5mg3aEuPQ961e2771" npx wrangler pages deploy teacher-app --project-name=teacher-csp --branch=main
```
