...
export const WARDROBE_ITEMS: WardrobeItem[] = [
  ...
  { id: 'frame-scholar', version: 1, category: 'frame', name: '博学桂冠', rarity: 'legendary', acquisition: { type: 'condition', description: '完成 30 节课程', achievementId: 'course-30' }, preview: 'scholar', asset: '/wardrobe/founders/frames/scholar.webp' },
  ...
  { id: 'pendant-pencil', version: 1, category: 'pendant', name: '灵感铅笔', rarity: 'rare', acquisition: { type: 'condition', description: '完成 10 节课程', achievementId: 'course-10' }, preview: 'pencil', asset: '/wardrobe/founders/pendants/pencil.webp' },
  ...
  { id: 'title-course', version: 1, category: 'title', name: '万卷星河', rarity: 'rare', acquisition: { type: 'condition', description: '完成 30 节课程', achievementId: 'course-30' } },
