...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // pet
            commands::pet::get_player_data,
            commands::pet::get_owned_pets,
            commands::pet::add_pet,
            commands::pet::set_active_pet,
            commands::pet::update_pet,
            commands::pet::add_coins,
            commands::pet::spend_coins,
            commands::pet::get_shop_items,
            commands::pet::get_inventory,
            commands::pet::add_inventory_item,
            commands::pet::redeem_code,
            commands::pet::get_unlocked_forms,
            commands::pet::unlock_form,
            // chat
